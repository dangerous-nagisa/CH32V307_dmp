...
int MPU6050_DMP_init(void)
{
    ...
    {
		uint8_t dibuff[20];
		sprintf((char *)dibuff, "mpu_init :%d\r\n", ret);
		printf("%s",dibuff);
    ...
    {
		uint8_t dibuff[20];
		sprintf((char *)dibuff, "mpu_set_sensors :%d\r\n", ret);
		printf("%s",dibuff);
    ...
    {
		uint8_t dibuff[20];
		sprintf((char *)dibuff, "mpu_configure_fifo :%d\r\n", ret);
		printf("%s",dibuff);
    ...
    {
		uint8_t dibuff[20];
		sprintf((char *)dibuff, "mpu_set_sample_rate :%d\r\n", ret);
		printf("%s",dibuff);
    ...
    {
		uint8_t dibuff[20];
		sprintf((char *)dibuff, "dmp_load_motion_driver_firmware :%d\r\n", ret);
		printf("%s",dibuff);
    ...
    {
		uint8_t dibuff[20];
		sprintf((char *)dibuff, "dmp_set_orientation :%d\r\n", ret);
		printf("%s",dibuff);
    ...
    {
		uint8_t dibuff[20];
		sprintf((char *)dibuff, "dmp_enable_feature :%d\r\n", ret);
		printf("%s",dibuff);
    ...
    {
		uint8_t dibuff[20];
		sprintf((char *)dibuff, "dmp_set_fifo_rate :%d\r\n", ret);
		printf("%s",dibuff);
...
//    }
    ...
    {
		uint8_t dibuff[20];
		sprintf((char *)dibuff, "mpu_set_dmp_state :%d\r\n", ret);
		printf("%s",dibuff);
